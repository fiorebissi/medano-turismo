  ...
  return (
    <article className='event' key={id}>
      ...
      <div className='event-detail'>
        ...
        <button type='button' className='bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded cursor-pointer'>
          Reservar!
        </button>
      </div>
    </article>
